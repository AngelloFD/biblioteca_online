...
class Libro(models.Model):
   ...
   summary = models.CharField(max_length=4000, null=False, blank=False) # Sujeto a cambios
...
class Ejemplares(models.Model):
   ...
   resumen = models.CharField(max_length=1000, null=False, blank=False) # Sujeto a cambios
...
class Prestamo(models.Model):
   ...
   fecha_prestamo = models.DateField(null=True, blank=False)
   fecha_devolucion = models.DateField(null=True, blank=False)
...
class ReclamoUsuario(models.Model):
   ...
   descripcion = models.CharField(max_length=1000, null=False, blank=False) # Sujeto a cambios
